...
function Questionstab() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`${connection.connectionURL}/api/user/getQuestions/${id}`)
      .then((response) => {
          console.log(response);
        setQuestions(response.data.data);
        setQc(response.data.qc)
...
<span class="s-post-summary--stats-item-number">{q.votes}</span>
...
<span class="s-post-summary--stats-item-number">{q.views}</span>
...
<a href="/questions/53781634/aggregation-in-pandas" class="s-link">{q.title}</a>
</h3>
...
<time class="s-user-card--time">asked <span title="2018-12-14 14:30:27Z" class="relativetime">{q.createdAt}</span></time>
</div>
